...
<div class="brz-groupLayout__content" data-columncount="<?php echo $column_count; ?>"
                ...
                <p class="brz-groupLayout-no-results">There are no groups available.</p>
