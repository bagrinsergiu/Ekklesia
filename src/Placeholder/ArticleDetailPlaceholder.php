...
{
    protected $name = 'ekk_article_detail';
    ...
    public function echoValue(ContextInterface $context, ContentPlaceholder $placeholder)
    {
        ...
        echo "<div class=\"brz-articleDetail__item\">";

        if ($show_title) {
            echo "<h2 class=\"brz-articleDetail__item--meta brz-ministryBrands__item--meta-title\">{$item['title']}</h2>";
        }

        if ($show_date && $item['date']) {
            echo "<h6 class=\"brz-articleDetail__item--meta brz-ministryBrands__item--meta-date\">";
        ...
        if ($show_category && $item['category']) {
            echo "<h6 class=\"brz-articleDetail__item--meta brz-ministryBrands__item--meta-category\">";
            if ($show_meta_headings) {
                if ($show_meta_icons) {
        ...
        if ($show_group && $item['group']) {
            echo "<h6 class=\"brz-articleDetail__item--meta brz-ministryBrands__item--meta-group\">";
            if ($show_meta_headings) {
                if ($show_meta_icons) {
        ...
        if ($show_series && $item['series']) {
            echo "<h6 class=\"brz-articleDetail__item--meta brz-ministryBrands__item--meta-series\">";
            if ($show_meta_headings) {
                if ($show_meta_icons) {
        ...
        if ($show_author && $item['author']) {
            echo "<h6 class=\"brz-articleDetail__item--meta brz-ministryBrands__item--meta-author\">";
            if ($show_meta_headings) {
                if ($show_meta_icons) {
        ...
        if ($show_audio && $item['audiourl']) {
            echo "<div class=\"brz-articleDetail__item--media--audio\">";
        ...
        if ($show_media_links_video || $show_media_links_audio || $show_media_links_download || $show_media_links_notes) {
            echo "<ul class=\"brz-articleDetail__item--media\">";
        ...
        if ($show_content && !empty($item['text'])) {
            echo "<div class=\"brz-articleDetail__item--content\">{$item['text']}</div>";
        }
