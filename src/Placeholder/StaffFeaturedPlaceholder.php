    ...
    public function echoValue(ContextInterface $context, ContentPlaceholder $placeholder)
    {
        ...
        <div class="brz-staffFeatured__container">
            <div class="brz-staffFeatured__item">
                ...
                if ($show_title) {
                    echo "<h3 class=\"brz-staffFeatured__item--meta--title\">{$member['fullname']}</h3>";
                }

                if ($show_position && $member['position']) {
                    echo "<h6 class=\"brz-staffFeatured__item--meta\">{$member['position']}</h6>";
                }

                if ($show_groups && $member['groups']) {
                    echo "<h6 class=\"brz-staffFeatured__item--meta\">";
